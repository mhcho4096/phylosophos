...
The following is the example result of executing PhyloSophos with a sample input file named ("sample_scientific_name_inputs.txt").
...
The following is an excerpt from the example result file generated by executing PhyloSophos with a sample input file named ("sample_scientific_name_inputs.txt").
